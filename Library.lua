...
-- Library functions 
    ...
    -- Library element functions
        function Library:Window(properties)
            ...
            local Items = Cfg.Items; do
                -- Window
                    Items.WindowGlow = Library:Create( "Frame" , {
                        Parent = Library.Items;
                        Name = "\0";
                        Position = dim2(0.5, -Cfg.Size.X.Offset / 2 - 6, 0.5, -Cfg.Size.Y.Offset / 2 - 6);
                        BorderColor3 = rgb(0, 0, 0);
                        Size = dim2(0, Cfg.Size.X.Offset + 12, 0, Cfg.Size.Y.Offset + 12);
                        BorderSizePixel = 0;
                        BackgroundTransparency = 0.82;
                        ZIndex = -1;
                        BackgroundColor3 = themes.preset.accent
                    }); Library:Themify(Items.WindowGlow, "accent", "BackgroundColor3")
                    
                    Library:Create( "UIStroke" , {
                        Parent = Items.WindowGlow;
                        ApplyStrokeMode = Enum.ApplyStrokeMode.Border;
                        Thickness = 2;
                        Transparency = 0.78;
                    ...
                    Library:Connection(Items.Window:GetPropertyChangedSignal("Position"), function()
                        Library:Tween(Items.WindowGlow, {
                            Position = dim2(Items.Window.Position.X.Scale, Items.Window.Position.X.Offset - 6, Items.Window.Position.Y.Scale, Items.Window.Position.Y.Offset - 6)
                        })
                    end)

                    Library:Connection(Items.Window:GetPropertyChangedSignal("Size"), function()
                        Library:Tween(Items.WindowGlow, {
                            Size = dim2(Items.Window.Size.X.Scale, Items.Window.Size.X.Offset + 12, Items.Window.Size.Y.Scale, Items.Window.Size.Y.Offset + 12)
                        })
                    end)
            ...
            function Cfg.ToggleMenu(bool) 
                ...
                Library:Tween(UIBlur, {Size = bool and 12 or 0})
                Library:Tween(Items.WindowGlow, {BackgroundTransparency = bool and 0.82 or 1})
        ...
        function Library:Toggle(properties) 
            ...
            local Items = Cfg.Items; do 
                ...
                Items.AccentGlow = Library:Create( "UIStroke" , {
                    Parent = Items.Accent;
                    ApplyStrokeMode = Enum.ApplyStrokeMode.Border;
                    Thickness = 1.5;
                    Transparency = 1;
                    Color = themes.preset.accent
                }); Library:Themify(Items.AccentGlow, "accent", "Color")
            ...
            function Cfg.Set(bool)
                ...
                Library:Tween(Items.AccentGlow, {Transparency = bool and 0.42 or 1})
        ...
        function Library:Slider(properties) 
            ...
            function Cfg.Set(value)
                ...
                Items.Accent.Size = dim2(Alpha, Cfg.Value == Cfg.Min and 0 or -2, 1, -2)
                Library:Tween(Items.AccentGlow, {Transparency = math.clamp(0.85 - (Alpha * 0.45), 0.35, 0.85)})
